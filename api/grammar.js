...
4. idiomatic expression은 절대 선택하지 않는다.
5. 오직 다음의 경우에 해당될 때만 붙어 있는 두 단어를 같이 선택할 수 있다. 그 외에는 낱개 단어만을 선택한다: 수동태(be + v-ed), 전치사 관계대명사 구문(전치사 +관계대명사)
===============
...
4. idiomatic expression은 절대 선택하지 않는다.
5. 오직 다음의 경우에 해당될 때만 붙어 있는 두 단어를 같이 선택할 수 있다. 그 외에는 낱개 단어만을 선택한다: 수동태(be + v-ed), 전치사 관계대명사 구문(전치사 +관계대명사)
6. 똑같은 요소를 여러 선택지에서 반복해서 물어서는 안되므로, [선택지후보]로 마킹된 단어가 묻는 요소와 겹치는 요소를 갖는 단어는 배제한다.
===============
